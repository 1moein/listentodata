...
tips <- function(){
    ...
    cat("  2. Before and after loading a dataset or running a line, you can check out the Environment(top right panel) to see what new variable/object was created.\n\n")
