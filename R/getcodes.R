...
cat("# in the Console, and copy the results from the Console\n")
cat("# to create a smaller analysis hub that I call a dashboard.\n")
cat("# Similar to the above instructions, paste it all \n")
