...
clear_console()
  ...
  cat("# ---------------- Course Setup Complete!---------------\n")
  cat("\n")
  cat("\n")
  cat("#****************************************************\n")
  cat("#--       Help on each analysis function          --\n")
  cat("#**************************************************** \n")
  cat("# Run each line to get function details in the Help panel\n")
  cat("?easyart\n")
  ...
  cat("\n")
  cat("# To learn more about using functions\n")
  cat("# Run the next line and check out the Console\n")
  cat("tips()\n")
  ...
  cat("# Each cell in this file will be a tweet, review, or document...\n")
  cat("# In Excel, press CTRL/Command H, to open the search and replace diaglog.\n")
  cat("# With your cursor in the Find What box, press CTRL/Command J, then click Replace All.\n")
  cat("# The above steps search for and replace all line breaks in your document which is \n")
  cat("# necessary as a preparation step for this analysis.\n")
  cat("# The next few lines prepare and run the analysis. \n")
  cat("library(listentodata)\n")
  cat("clear_console()\n")
  cat("textdata = load_csv_data()\n")
  cat("words2remove = c(\"toremvoe1\", \"toremove2\")\n")
  cat("stemthis = FALSE\n")
  cat("wcmf = 5 #Word Cloud Minimum Frequency: default = 5\n")
  cat("mostfrequent = 25\n")
  cat("Run_Sentiment_Analysis(textdata, stemthis, wcmf, mostfrequent)\n")
  cat("\n")
  cat("print('Analysis Complete!')\n")
  cat("\n")
  cat("\n")
