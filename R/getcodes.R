...
cat("#################################################\n")
cat("\n")
cat("# Run the next few lines to install/update the listentodata package and get the codes\n")
cat("# If the console shows you a list of packages to update, and waits for your input,\n")
cat("# skip the updates by CLICKING IN THE CONSOLE first, and THEN PRESSING Enter/Return on your keyboard.\n")
...
cat("# Then, create a new R Script by going to\n")
cat("# File > New File > R Script \n")
cat("# Paste the copied code (CTRL-V, Cmnd-V, Right Click + Paste\n")
cat("# into the blank file. Then, Go to File > Save as\n")
cat("# and save the script as Analysis_Hub.R\n")
cat("# All our RStudio analyses will be carried out \n")
cat("# inside this Analysis_Hub.R file.\n")
cat("# ========================================\n")
...
cat("# Similar to the above instructions, you need to paste everything \n")
